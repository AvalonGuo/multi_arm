...
class GraspPPOEnv(RobotTaskEnv):
    def __init__(
        self,
        ...
        robot = Panda(sim,body_name="panda",block_gripper=False, base_position=np.array([-0.5, 0.0, 0.0]), control_type=control_type)
...
tb_log_name = f"Grasp_PPOCNN_{learning_rate}" 
model_save_name = f"Grasp_PPOCNN_{learning_rate}.zip"
