...
class Multi_Reach(Task):
    ...
    def _create_scene(self) -> None:
        ...
        self.sim.create_sphere(
            ...
            mass=0.0,
            ghost=True,
            position=np.array([-0.25,0.125,0.17]),
    ...
    def is_success(self, achieved_goal: np.ndarray, desired_goal: np.ndarray) -> np.ndarray:
        ...
        return np.array(d1 < self.distance_threshold and d2<self.distance_threshold and d3<self.distance_threshold and d4 <self.distance_threshold, dtype=bool)
